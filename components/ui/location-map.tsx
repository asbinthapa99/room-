      ...
      >
          ...
          {isExpanded && (
            ...
            >
              ...
              {[
                ...
                <motion.div key={i} className="absolute rounded-sm bg-muted-foreground/25 border border-muted-foreground/15"
                  style={{ top: b.top, left: "left" in b ? b.left : undefined, right: "right" in b ? b.right : undefined, width: b.w, height: b.h }}
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          <div className="flex items-start justify-between">
            <motion.div animate={{ opacity: isExpanded ? 0 : 1 }} transition={{ duration: 0.3 }}>
              <motion.svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                ...
                animate={{ filter: isHovered ? "drop-shadow(0 0 8px rgba(225,29,72,0.5))" : "drop-shadow(0 0 4px rgba(225,29,72,0.2))" }}
          ...
          <div className="space-y-1">
            <motion.h3 className="text-foreground font-semibold text-sm tracking-tight"
            ...
            <motion.div className="h-px bg-gradient-to-r from-brand-500/50 via-brand-400/30 to-transparent"
