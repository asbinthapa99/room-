...
const colorVariants: Record<ColorVariant, {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#7f0020] to-[#e11d48]",
    inner: "bg-gradient-to-b from-[#fb7185] via-[#9f1239] to-[#fda4af]",
    button: "bg-gradient-to-b from-[#f43f5e] to-[#be123c]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(127_0_32_/_100%)]",
  },
  success: {
