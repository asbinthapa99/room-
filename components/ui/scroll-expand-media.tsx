          ...
          <div className="container mx-auto flex flex-col items-center justify-start relative z-10">
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                {/* Date + scroll hint fly apart */}
                <div className="flex flex-col items-center text-center relative z-10 mt-4">
                  {date && (
                    <p className="text-lg text-white/70" style={{ transform: `translateX(-${textTranslateX}vw)` }}>
                      {date}
                    </p>
                  )}
                  {scrollToExpand && (
                    <p className="text-white/60 font-medium text-sm" style={{ transform: `translateX(${textTranslateX}vw)` }}>
                      {scrollToExpand}
                    </p>
                  )}
                </div>
            ...
            <motion.section
              className="flex flex-col w-full px-4 md:px-8 lg:px-16 py-10 lg:py-20"
              initial={{ opacity: 0 }}
